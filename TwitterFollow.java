...
public class TwitterFollow {
	...
	public static void main(String[] args){
		...
		driver.get("https://twitter.com/who_to_follow/suggestions");
	...
	public static void follow(){
		...
		followButtons = driver.findElements(By.xpath("//span[contains(text(), 'Follow')]"));
		System.out.println(followButtons.size());
	}
	
	public static void followUsers(){

		followButtons = driver.findElements(By.xpath("//span[contains(text(), 'Follow')]/following-sibling::node()"));
